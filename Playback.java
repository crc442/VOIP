...
public class Playback implements Runnable {
    ...
    new AudioFormat(AudioFormat.Encoding.PCM_SIGNED, 8000.0F, 8, 1, 1, 8000.0F, false);
    //encoding-audio encoding technique
    //float sampleRate(no of samples per seconds),
    //int sampleSizeInBits(no of bits in each sample),
    //int channels(1for mono 2for stereo),
    //int frameSize(bytes in each frame),
    //float frameRate,
    //boolean littleEndian byte order
